  ...
  # /Applications/MATLAB_R2024a.app/bin/mex -v zhfmm3dmex.c zfmm3dfortran.a \
  # -largeArrayDims -DMWF77_UNDERSCORE1 -output zhfmm3dmex  -lgfortran -L/opt/homebrew/Cellar/gcc/14.2.0_1/lib/gcc/current -lgomp


  # /Applications/MATLAB_R2024a.app/bin/mex -v zh3devaldirectmex.c zfmm3dfortran.a  \
  # -largeArrayDims -DMWF77_UNDERSCORE1 -output zh3devaldirectmex  -lgfortran -L/opt/homebrew/Cellar/gcc/14.2.0_1/lib/gcc/current -lgomp

  
  # /Applications/MATLAB_R2024a.app/bin/mex -v zlfmm3dmex.c zfmm3dfortran.a \
  # -largeArrayDims -DMWF77_UNDERSCORE1 -output zlfmm3dmex  -lgfortran -L/opt/homebrew/Cellar/gcc/14.2.0_1/lib/gcc/current -lgomp
  
  # /Applications/MATLAB_R2024a.app/bin/mex -v zl3devaldirectmex.c zfmm3dfortran.a \
  # -largeArrayDims -DMWF77_UNDERSCORE1 -output zl3devaldirectmex  -lgfortran -L/opt/homebrew/Cellar/gcc/14.2.0_1/lib/gcc/current -lgomp
