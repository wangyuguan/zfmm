...
c
     ...
     1    nlmin, nlmax, ifunif, iper, isep, nlevels, nboxes, ltree)
c
c
c
c----------------------------------------
...
c
     ...
     1    nlmin, nlmax, ifunif, iper, isep, bs0, cen0, nlevels, 
     2    nboxes, ltree)
...
C$OMP END PARALLEL DO        
     ...
     1      nlmax,iper,isep,mnbors,laddr,ilevel,iparent,nchild,ichild,
     2      nnbors,nbors)
        endif

      endif
      nboxes8 = nboxes
      ltree = (12+mnbors)*nboxes8 + 2*(nlevels+1) 
...
c
     ...
     1  nlmin, nlmax, ifunif, iper, isep, nlevels, nboxes, bs0, 
     2  cen0, ltree, itree, iptr, centers, boxsize)
...
c
     ...
     1  nlmin, nlmax, ifunif, iper, isep, nlevels, nboxes, bs0, cen0, 
...
C$OMP END PARALLEL DO      
     ...
     1         nboxes0,boxsize,nboxes,nlevels,iper,isep,mnbors,
...
c-------------------------------------------------------------      
     ...
     1       boxsize,nbmax,nlmax,iper,isep,mnbors,laddr,ilevel,
...
c               Check if kbox is a nearest neighbor or in list 2
     ...
     3                isep*1.05*boxsize(ilev+1)).and.
