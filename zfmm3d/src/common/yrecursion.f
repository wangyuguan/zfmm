...
c
      integer nmax, m, n
      double complex z, y(0:nmax,0:nmax), d(0:nmax,0:nmax), u, u2, du
c      u=-sqrt(1-z*z)
      u2 = 1-z**2
c      u = sqrt(u2)
      call zsqrt(u2,u)
...
c
      integer nmax, m, n
      double complex z, y(0:nmax,0:nmax), d(0:nmax,0:nmax), u,u2
      double complex ztmp
...
c
      integer nmax, m, n
      double complex z, y(0:nmax,0:nmax), u,u2
      double precision rat1(0:nmax,0:nmax), rat2(0:nmax,0:nmax)
      u2 = 1-z**2
      call zsqrt(u2,u)
      u = -u
...
c
      ...
      do m=0, nmax
	 if (m.gt.0)  y(m,m)=y(m-1,m-1)*u*rat1(m,m)
c	 if (m.gt.0)  d(m,m)=(d(m-1,m-1)*u+du)*rat1(m,m)
	 if (m.gt.0)  d(m,m)=y(m,m)*(-m)*z/u**2
	 if (m.lt.nmax)  y(m+1,m)=z*y(m,m)*rat1(m+1,m)
