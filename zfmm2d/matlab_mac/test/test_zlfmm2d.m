...
tic 
[pot_ex, grad_ex] = zl2devaldirect(n,ztarg,n,zsrc,charge,dipstr,dipvec,ifcharge,ifdipole,ifpgh); 
toc 


eps = 1e-12;
tic 
[pot, grad] = zlfmm2d(eps,n,zsrc,ifcharge,charge,ifdipole,dipstr,dipvec,n,ztarg,ifpgh,isep);
toc
