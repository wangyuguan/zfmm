...
### zlfmm3d — 3D complex Laplace FMM

This routine evaluates the 3D Laplace potential with optional dipole contributions using a fast multipole method with complex coordinates.

For target points x<sub>i</sub>, the computed field is

![](https://latex.codecogs.com/svg.image?u(x_i)%3D%5Cfrac%7B1%7D%7B4%5Cpi%7D%5Csum_%7Bj%3D1%7D%5E%7Bn_s%7D%20q_j%5Cfrac%7B1%7D%7BR(x_i%2Cy_j)%7D%20-%20%5Cfrac%7B1%7D%7B4%5Cpi%7D%5Csum_%7Bj%3D1%7D%5E%7Bn_s%7D%20d_j%5Cleft%5Clangle%20v_j%2C%5Cnabla_y%5Cfrac%7B1%7D%7BR(x_i%2Cy_j)%7D%20%5Cright%5Crangle)

where

![](https://latex.codecogs.com/svg.image?R(x%2Cy)%3D%5Csqrt%7B(x_1-y_1)%5E2%2B(x_2-y_2)%5E2%2B(x_3-y_3)%5E2%7D.)
...
```matlab
[pot, grad] = zlfmm3d(eps, ns, zsrc, ifcharge, charge, ...
                      ifdipole, dipstr, dipvec, nt, ztarg, ifpgh, isep);
```
